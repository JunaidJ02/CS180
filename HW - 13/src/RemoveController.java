...
public final class RemoveController {
    ...
    private void getRemoveButtonSemantics() {
        if (inventoryModel.searchBySku(removeView.getSkuTextField().getText()).isEmpty()) {
            JOptionPane.showMessageDialog(null, "A product with the specified SKU does not exist in the inventory!",
